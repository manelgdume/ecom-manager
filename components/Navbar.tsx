...
function Navbar() {
    ...
    return (
        <div className="flex h-screen">
            ...
            <div className="background w-1/8 flex flex-col py-4 px-2 border border-r-border">
            <div className="w-full items-center justify-center mb-2 mr-14 ml-4 border-1 ">
