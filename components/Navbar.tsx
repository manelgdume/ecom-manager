...
function Navbar() {
     ...
     useEffect(() => {
        ...
        if (url.includes("dashboard")) {
            ...
            if (dashboardElement) {
                ...
                dashboardElement.classList.add("bg-primary");
        ...
        if (url.includes("products")) {
            ...
            if (productsElement) {
                ...
                productsElement.classList.add("bg-primary");
        ...
        if (url.includes("orders")) {
            ...
            if (ordersElement) {
                ...
                ordersElement.classList.add("bg-primary");
        ...
        if (url.includes("users")) {
            ...
            if (usersElement) {
                ...
                usersElement.classList.add("bg-primary");
            }
        }
    ...
    return (
        ...
        <div className='bg-background border-secondary border-r-2 '>
            <div className="flex h-screen">
                <div className=" w-1/8 flex flex-col py-4 px-2 ">
                    ...
                    <div className="flex w-full space-y-4 mb-2 mr-14 border-1">
                        <Link id='products' href="/products"
                            className="inline-flex items-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2 w-full justify-start">
